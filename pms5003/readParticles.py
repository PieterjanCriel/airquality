...
class g3sensor():
    ...
    def read_data(self):
        ...
        pm1_cf=float(data_hex[4]+data_hex[5]+data_hex[6]+data_hex[7],16)
        pm25_cf=float(data_hex[8]+data_hex[9]+data_hex[10]+data_hex[11],16)
        pm10_cf=float(data_hex[12]+data_hex[13]+data_hex[14]+data_hex[15],16)
        pm1=float(data_hex[16]+data_hex[17]+data_hex[18]+data_hex[19],16)
        pm25=float(data_hex[20]+data_hex[21]+data_hex[22]+data_hex[23],16)
        pm10=float(data_hex[24]+data_hex[25]+data_hex[26]+data_hex[27],16)
